...
import 'package:financial_tracker/viewmodels/add_transaction.dart';
              ...
              children: [
                ...
                if (_viewModel.mainCategory != null)
                  DropdownButtonFormField<String>(
                    ...
                    items: _viewModel.subCategories[_viewModel.mainCategory!]!
                        ...
                        .toList(),
                    onChanged: (val) => setState(() => _viewModel.subCategory = val),
                    validator: (val) =>
                ...
                if (_viewModel.type == 'Transfer')
                  DropdownButtonFormField<String>(
                    ...
                    decoration: const InputDecoration(labelText: 'Fund Destination'),
                    items: _viewModel.fundDestinations
                        .map((f) => DropdownMenuItem(value: f, child: Text(f)))
                        .toList(),
                    onChanged: (val) => setState(() => _viewModel.fundDestination = val),
